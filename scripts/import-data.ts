...
import { db, dispositif, domaine, domaineSol, parcelle, parcelleType, sdc, sdcRealisePerfMagasinCan, synthetise, zone } from "../src";
...
const importConfigs: ImportConfig[] = [
	...
	{
		category: "magasin",
		files: ["sdc_realise_performance_magasin_can.csv"],
		handlers: {
